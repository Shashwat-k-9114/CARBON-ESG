...
print("=== UI-ALIGNED MODEL TRAINING ===")
...
for _ in range(n):
    ...
    electricity = np.random.uniform(50, 600)
    ...
    # Carbon calculation
    c_elec = electricity * 12 * country_ef[country] * energy_multiplier[energy]
    ...
    total *= np.random.normal(1.0, 0.05)

    data.append([
        country, electricity, energy, vehicle,
        km, flight, diet, shop, recycle, total
    ])

df = pd.DataFrame(data, columns=[
    "country", "electricity_kwh", "energy_source",
    "vehicle_type", "vehicle_km", "flight_type",
...
}, "models/carbon_model_ui_aligned.pkl")
